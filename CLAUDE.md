...
```bash
python C:\Users\firer\aibus\aibus.py post --from <agent> --topic genemap "..."
python C:\Users\firer\aibus\aibus.py note --from <agent> --title "..." --tag genemap "..."
```

Use the topic `genemap` for this repo — one topic per subject of work, not per session.
