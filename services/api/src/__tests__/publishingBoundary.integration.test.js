...
const DIRECT_PERSONAL_CARE_CASES = Object.freeze([
  ...
  ['safe source followed by named raw genomic record', 'Analyze raw genomic data from an anonymized cohort, then analyze raw genomic data from Jane Doe.'],
  ['patient-role named raw genomic record', 'Analyze raw genomic data from Patient Smith.'],
  ['lower-case patient-role named raw genomic record', 'Analyze raw genomic data from patient Smith.'],
  ['participant-role named raw genomic record', 'Analyze raw genomic data from Participant Jones.'],
  ...
  ['lower-case gene-symbol self-classification', 'Classify me from brca1.'],
  ['lower-case letters-only gene-symbol self-classification', 'Classify me from cftr.'],
...
const AGGREGATE_RESEARCH_CASES = Object.freeze([
  ...
  ['course self-assessment source', 'Assess myself based on my course performance.'],
  ['training self-evaluation source', 'Evaluate myself using the training rubric.'],
