...
const DIRECT_PERSONAL_CARE_CASES = Object.freeze([
  ...
  ['positive-for medication', 'I am positive for taking warfarin.'],
  ['raw DNA result interpretation', 'Here are my raw DNA results—what do they mean?'],
  ['raw patient-level WES', 'I was told I have raw patient-level WES records from 50 patients and need to compare variants across the cohort.'],
...
const AGGREGATE_RESEARCH_CASES = Object.freeze([
  ...
  ['reported WES research material', 'I was told I have anonymized aggregate WES data from 50 patients and need to compare variants across the cohort.'],
