  ...
  return (
    <Card className={`shadow-md hover:shadow-lg transition-all duration-200 ${isSelected ? 'ring-2 ring-blue-500 bg-blue-50/30' : ''}`}>
      ...
      <CardContent>
        ...
        {/* Honesty disclaimer: coordinates, IDs, and HPO associations on this
            card are AI-generated from the model's knowledge, not fetched from a
            live genomic database, so they can be approximate or wrong. Mirrors
            the GSEA page's disclaimer. */}
        <div className="mb-4 flex items-start gap-2 text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-md px-3 py-2">
          ...
          <span>
            <strong>AI-estimated metadata.</strong> Coordinates, gene IDs, and HPO phenotype
            associations are generated by AI and not validated against NCBI/Ensembl/HPO. Verify
            against official databases before any clinical or research use.
          </span>
        </div>
